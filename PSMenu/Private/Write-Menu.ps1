...
function Write-Menu {
    ...
    for ($i = 0; $i -le $MenuItemCount; $i++) {
        ...
        $DisplayText = Format-MenuItem -MenuItem $MenuItemStr -SeparatorValue:$SeparatorValue -MultiSelect:$MultiSelect -IsItemSelected:$IsItemSelected -IsItemFocused:$IsItemFocused
